...
urlpatterns = patterns('',
    ...
    # api docs
    (r'^api/$', RedirectView.as_view(url='http://docs.openstates.org/api/', permanent=True)),
    (r'^api/metadata/$', RedirectView.as_view(url='http://docs.openstates.org/api/metadata.html', permanent=True)),
    (r'^api/bills/$', RedirectView.as_view(url='http://docs.openstates.org/api/bills.html', permanent=True)),
    (r'^api/committees/$', RedirectView.as_view(url='http://docs.openstates.org/api/committees.html', permanent=True)),
    (r'^api/legislators/$', RedirectView.as_view(url='http://docs.openstates.org/api/legislators.html', permanent=True)),
    (r'^api/events/$', RedirectView.as_view(url='http://docs.openstates.org/api/events.html', permanent=True)),
    (r'^api/districts/$', RedirectView.as_view(url='http://docs.openstates.org/api/districts.html', permanent=True)),
