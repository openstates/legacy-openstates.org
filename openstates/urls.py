...
urlpatterns = patterns('',
    ...
    # api docs
    (r'^api/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/', permanent=True)),
    (r'^api/metadata/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/metadata.html', permanent=True)),
    (r'^api/bills/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/bills.html', permanent=True)),
    (r'^api/committees/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/committees.html', permanent=True)),
    (r'^api/legislators/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/legislators.html', permanent=True)),
    (r'^api/events/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/events.html', permanent=True)),
    (r'^api/districts/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/districts.html', permanent=True)),
