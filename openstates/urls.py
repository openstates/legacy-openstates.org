...
urlpatterns = patterns('',
    ...
    # api docs
    (r'^api/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/')),
    (r'^api/metadata/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/metadata.html')),
    (r'^api/bills/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/bills.html')),
    (r'^api/committees/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/committees.html')),
    (r'^api/legislators/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/legislators.html')),
    (r'^api/events/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/events.html')),
    (r'^api/districts/$', RedirectView.as_view(url='https://openstates.github.io/openstates-api/districts.html')),
